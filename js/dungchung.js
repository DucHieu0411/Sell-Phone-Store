	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/toibinwng" class="fa fa-facebook"></a>
                <a href="https://twitter.com/KoBen56946647" class="fa fa-twitter"></a>
                <a href="https://contacts.google.com/person/c8642637760019382767?hl=vi" class="fa fa-google"></a>
                <a href="https://www.youtube.com/channel/UCJNEsFW9KyZUSwTP6SJ1Q-A" class="fa fa-youtube"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/smartphone-shop.png" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">SellPhone Store</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">Nguyễn Đức Hiếu</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #288ad6;">0935014524</a>
                </li>
            </ul>
        </section>
    </div>`);
